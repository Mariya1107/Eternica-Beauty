    ...
    <Box sx={{ pt: '110px', pb: 6, px: 2 }}>
      <Grid container spacing={4} justifyContent="center" sx={{ maxWidth: 1200, mx: 'auto' }}>
        <Grid item xs={12} md={6}>
              ...
              .map((img, index) => (
                <Box
                  ...
                  sx={{
                    ...
                    height: 100,
                    objectFit: 'cover',
                    border: mainImage === img ? '3px solid #BA9EDC' : '2px solid #ccc',
                    borderRadius: 2,
                    cursor: 'pointer',
                    transition: '0.3s ease-in-out',
                    '&:hover': {
                      border: '3px solid #BA9EDC',
                      boxShadow: '0 0 10px #E0C6FF',
                    },
                  }}
                />
              ))}
          ...
          {/* Safety Information */}
          <Box sx={{ mt: -5 }}>
            <Typography variant="h6" fontWeight={200} gutterBottom>Safety Information</Typography>
          ...
          {relatedProducts.length > 0 && (
            <Box sx={{ mt: 6, width: '100%' }}>
              <Typography variant="h6" fontWeight={700} gutterBottom>Related Products</Typography>
        ...
        <Grid item xs={12} md={6} sx={{ ml: { md: 20 } }}>
          <Stack spacing={2}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Box sx={{ backgroundColor: product.in_stock ? '#CFF7D3' : '#FDDCDC', color: product.in_stock ? '#02542A' : '#8B0000', px: 1.5, py: 0.2, borderRadius: '10px', fontWeight: 600, fontSize: '13px', fontFamily: 'Poppins' }}>
                {product.in_stock ? 'In Stock' : 'Out of Stock'}
              </Box>
            </Box>

            <Box sx={{ backgroundColor: '#CFF7D3', color: '#02542A', width: '120px', textAlign: 'center', py: 0.3, borderRadius: '5px', fontWeight: 600, fontSize: 14, fontFamily: 'Poppins' }}>
              {product.brand}
            </Box>

            <Typography variant="h5" fontWeight={600} color="#000" sx={{ mt: 2 }}>
            ...
            {/* Available Quantities with Hover */}
